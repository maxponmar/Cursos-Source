...
\author{Héctor~Bacilio,~\IEEEmembership{Miembro,~IEEE,}
        Héctor~Bacilio,~\IEEEmembership{Fellow,~OSA,}
        y~Héctor~Bacilio,~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
\thanks{Héctor Bacilio1 Universidad de Guadalajara
 e-mail: (see hectormisael.bn@gmail.com).}% <-this % stops a space
...
% The paper headers
\markboth{Revista \LaTeX\ archivos,~Vol.~1, No.~5, Marzo~2017}%
{muestra \MakeLowercase{\textit{et al.}}: Ejemplo IEEEtran.cls para IEEE revista}
...
\begin{IEEEkeywords}
IEEE, IEEEtran, journal, \LaTeX, paper, template, articulo, revista.
\end{IEEEkeywords}
...
\IEEEPARstart{E}{ste} es un ejemplo(\ref{eqn_example}) de un articulo escrito en formato IEEE.
\begin{equation}
\label{eqn_example}
...
\begin{figure*}[!t]
\centering
\subfloat[Case I]{\includegraphics[width=2.5cm]{figuras/fig3d_1}
\label{fig_first_case}}
\hfil
\subfloat[Case II]{\includegraphics[width=2.5cm]{figuras/fig3d_2}
...
\bibitem{ref2}
referencia numero 2 \emph{A Guide to \LaTeX}, 3rd~ed.\hskip 1em plus
  0.5em minus 0.4em\relax Harlow, England: Addison-Wesley, 1999.

\bibitem{ref3}
referencia numero 3 \emph{A Guide to \LaTeX}, 3rd~ed.\hskip 1em plus
  0.5em minus 0.4em\relax Harlow, England: Addison-Wesley, 1999.
\end{thebibliography}
...
% simpler here.)
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figuras/foto2}}]{Hector Misael}
% or if you just want to reserve a space for a photo:

%\begin{IEEEbiography}{Hector Misael}
información del autor 1 información del autor 1
